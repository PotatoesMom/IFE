...
function drawHistogram(data) {
    ...
    let histogram = "";
    histogram += "<line x1='10' y1='715' x2=" + (shaftWidth + 10).toString() + " y2='715' stroke-width='1' stroke=" + axisColor + " />" +
        "<line x1='10' y1="+ (shaftHeight + 5).toString() +" x2='10' y2='5' stroke-width='1' stroke=" + axisColor + " />" ;
    ...
    for (let i = 0; i < data[0].length; i++) {
        ...
        node.setAttribute("y", (715 - data[0][i]).toString());
        node.setAttribute("height", (data[0][i]).toString());
